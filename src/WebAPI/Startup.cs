...
namespace DesignPatternSamples.WebAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseDetranVerificadorRestricoesFactory();
    ...
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services)
        {
            return services
                ...
                .AddTransient<IDetranVerificadorRestricoesService, DetranVerificadorRestricoesServices>()
                .Decorate<IDetranVerificadorRestricoesService, DetranVerificadorRestricoesDecoratorCache>()
                .Decorate<IDetranVerificadorRestricoesService, DetranVerificadorRestricoesDecoratorLogger>()
                .AddSingleton<IDetranVerificadorRestricoesFactory, DetranVerificadorRestricoesFactory>()
                .AddTransient<DetranPEVerificadorRestricoesRepository>()
                .AddTransient<DetranRJVerificadorRestricoesRepository>()
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder UseDetranVerificadorRestricoesFactory(this IApplicationBuilder app)
        {
            app.ApplicationServices.GetService<IDetranVerificadorRestricoesFactory>()
                .Register("PE", typeof(DetranPEVerificadorRestricoesRepository))
                .Register("RJ", typeof(DetranRJVerificadorRestricoesRepository));
